...
This notebook trains a simple neural network, using the equations for backpropagation derived in my previous posts ([1]({% post_url neural_networks/2026-04-26-backpropagation %}), [2]({% post_url neural_networks/2026-05-02-backpropagation-vectorized %})). The equations are verified against the gradients computed by PyTorch's autograd engine.
